...
const HeroSection = () => {
  return (
    <div className='realtive h-96 flex justify-center items-center'>
        <div className='absolute bg-stone-300 opacity-20 h-36 w-36 lg:h-52 lg:w-52 rounded-full blur-2xl'></div>
        <div className="absolute flex flex-col items-center">
            <h1 className='text-white text-center font-dgs font-semibold text-5xl lg:text-7xl py-5'>Sup, I'm Kevin.</h1>
