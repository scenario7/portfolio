...
const ContactCard = () => {
  return (
    <div className='flex items-center flex-col md:flex-row lg:flex-row py-5 px-5 md:justify-between lg:justify-between bg-stone-900 backdrop-opacity-10 w-full rounded-2xl'>
